...
2. **Расширение**: Установите [EditThisCookie (V3)](https://chromewebstore.google.com/detail/editthiscookie-v3/ojfebgpkimhlhcblbalbfjblapadhbol)
...
> **⚠️ После установки**: Обязательно выполните [настройку аутентификации](./SETUP.md) перед использованием!
...
### 🎯 **UniversalDialog**
- 📖 **Полная документация**: [docs/UNIVERSAL_DIALOG.md](./docs/UNIVERSAL_DIALOG.md)
...
- 📖 **Полная документация**: [docs/JSON_BUILDER.md](./docs/JSON_BUILDER.md)
- 🏗️ Полный контроль над JSON структурами запросов
